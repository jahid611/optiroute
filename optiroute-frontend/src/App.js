...
// ==============================================================================
// 👇 SEULE MODIFICATION ICI : Le fond est maintenant semi-transparent et flouté
// ==============================================================================
const panelContainerStyle = (isMobile) => ({ 
    width: isMobile ? '100%' : '450px', 
    height: isMobile ? 'auto' : '100%', 
    minHeight: isMobile ? '60vh' : '100%', 
    // backgroundColor: COLORS.WHITE,  <-- ANCIEN
    backgroundColor: 'rgba(245, 247, 250, 0.85)', // NOUVEAU : Blanc cassé transparent
    backdropFilter: 'blur(15px)', // NOUVEAU : Effet de flou
    WebkitBackdropFilter: 'blur(15px)', // NOUVEAU : Pour Safari
    padding: '25px', 
